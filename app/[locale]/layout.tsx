...
import { fontOleoScript, fontInter, fontUbuntu } from "@/config/fonts";
...
export default function LocaleLayout(
  ...
  return (
    <html lang={locale} className="scroll-smooth! relative">
      <body
        className={`${fontUbuntu.className} ${fontOleoScript.variable} max-w-7xl mx-auto bg-gray-50 text-gray-950 relative dark:bg-gray-900 dark:text-gray-50 dark:text-opacity-90`}
      >
