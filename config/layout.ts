// 自己紹介タイルは、狭い画面（sm 以下＝2カラム）では中身が入りきらない。
// アバター96 + 本文4行131 + アイコン列58 + 余白40 = 325px に対し、
// h:2 だと 255px しかなく overflow-hidden がアイコン列を切っていた。
// 本文の行数は言語で変わるので、いちばん長い言語でも収まる h:3（390px）にする。
...
export const layouts: Record<string, Layouts> = {
  all: {
    lg: [
      ...
      { i: "cardStack", x: 0, y: 2, w: 2, h: 3 },
      { i: "paper", x: 3, y: 0, w: 1, h: 5 },
      { i: "animatedEmoji", x: 2, y: 0, w: 1, h: 2 },
      { i: "mapComponent", x: 2, y: 1, w: 1, h: 2 },
      { i: "iconCloud", x: 2, y: 3, w: 1, h: 3 },
      { i: "webAgent", x: 2, y: 1, w: 1, h: 2 },
